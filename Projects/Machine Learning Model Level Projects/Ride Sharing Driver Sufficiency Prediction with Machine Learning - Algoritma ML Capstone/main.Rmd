...
### Metrics
Saya akan menggunakan score metrik pada prediksi data test sebagai pembanding agar score yang dibandingkan **bukanlah hasil overfitting**. Untuk kasus ini, karena saya berpendapat bahwa kedua kondisi (FN & FP) sama-sama penting, maka saya akan menggunakan **accuracy** sebagai metrik utama. Dan untuk evaluasi ini, "insufficient" akan menjadi kelas positif. Saya juga akan melihat keseimbangan antara sensitivity dan specificity.
...
```
> Setelah dibandingkan di submisi, model decision tree menjadi model terbaik dengan score berikut:
>
> * Accuracy: 82%
> * Recall: 89%
> * Precision: 81%
