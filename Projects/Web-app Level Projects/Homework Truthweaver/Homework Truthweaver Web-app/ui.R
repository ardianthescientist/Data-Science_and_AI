    ...
    tabItems(
      ...
      tabItem(
        ...
        fluidRow(
          box(
            width = 12,
            actionLink("sample_dataset", "Need a sample dataset to try?") %>% div(style = "float: left; width: 50%;"),
